                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="center_absolute display_grid" action="" method="post">
                            ...
                            ?>
                                        <?= $name ?>
                                        <input class="form-control mb-3" type="text" name="name" placeholder="Doctor Name" value="<?= $name ?>">
                                        ...
                                        <input class="form-control mb-3" type="text" name="message" placeholder="Enter Your Message" value=" Hello Doctor <?= $name ?>, your HMS-System login informations are; E-Mail:<?= $email ?> | Password:<?= $password ?> | Your secretary name: <?= $secretary_name ?>. Have a good day... [HMS-Admin]">

                                        
                    </div>
                    <div class="card-footer">
                                            <a href="admin-doctor.php" class="btn btn-danger float-start">Cancel</a>
